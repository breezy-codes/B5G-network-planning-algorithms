...
def GEGASM(individuals, run_id, output_dir, solution_names=None, RUs=None, DUs=None, CUs=None, users=None, graph=None, max_iterations=100, time_limit_minutes=None, num_neighbours=10, num_mutations=5, crossover_interval=5, elite_pop=5, num_clones = 5, log_file=None, best_individual_per_iteration_path=None, save_interval=None):
...
def save_GEGASM(best_solution_path, RUs, DUs, CUs, users, output_dir, graph, scenario, run_id, max_iterations=100, num_neighbours=10, num_mutations=5, num_solutions=5, crossover_interval=5, save_interval=5, elite_pop=5, num_clones=5, time_limit_minutes=None):
...
def GEGA(individuals, run_id, output_dir, solution_names=None, RUs=None, DUs=None, CUs=None, users=None, graph=None, max_iterations=100, time_limit_minutes=None, num_neighbours=10, num_mutations=5, crossover_interval=5, elite_pop=5, num_clones = 5, log_file=None, best_individual_per_iteration_path=None, save_interval=None):
    """Run GA over multiple individual solutions. Each individual explores its own neighbourhood per iteration, and all individuals are processed in parallel each iteration."""
...
def save_GEGA(best_solution_path, RUs, DUs, CUs, users, output_dir, graph, scenario, run_id, max_iterations=100, num_neighbours=10, num_mutations=5, num_solutions=5, crossover_interval=5, save_interval=5, elite_pop=5, num_clones=5, time_limit_minutes=None):
    # Initialise multiple individual solutions from JSON
    ...
    with open(log_path, "a") as log_file:
        timestamp = datetime.now().strftime("%Y-%m-%d %H:%M:%S,%f")[:-3]
        (final_solutions, best_log_lists, mutation_counters, final_solution_names, best_solution, best_logs, best_mutations, best_name) = GEGA(individuals, run_id, output_dir, solution_names=solution_names, RUs=RUs, DUs=DUs, CUs=CUs, users=users, graph=graph, max_iterations=max_iterations, time_limit_minutes=time_limit_minutes, num_neighbours=num_neighbours, num_mutations=num_mutations, crossover_interval=crossover_interval, elite_pop=elite_pop, num_clones=num_clones, log_file=log_file, best_individual_per_iteration_path=best_individual_per_iteration_path, save_interval=save_interval)
